...
if __name__ == '__main__':
	...
	for iSource, DeltaSource in enumerate(DeltaSourceList):
		...
		# PM(h)
		# ------------------------------------------------------------
		pm_h = OpticalElement(Optics.MirrorPlane(L=L, AngleGrazing=AngleGrazing),
							  PositioningDirectives=Foundation.PositioningDirectives(
								  ...
								  Distance=40.),
							  Name='pm_h')
		pm_h.ComputationSettings.UseFigureError = False
		pm_h.CoreOptics.Orientation = Optics.OPTICS_ORIENTATION.Horizontal
		...
		pm_h.ComputationSettings.NSamples = 3000
		pm_h.ComputationSettings.UseCustomSampling = True
