...
if __name__ == '__main__':
	...
	for iSource, DeltaSource in enumerate(DeltaSourceList):
		...
		s_k.Orientation = Optics.OPTICS_ORIENTATION.Any
		...
		kb_k.Orientation = Optics.OPTICS_ORIENTATION.Vertical
		...
		pm_pd = Fundation.PositioningDirectives(
			ReferTo='upstream',
			PlaceWhat='centre',
			PlaceWhere='centre',
			Distance=8)
		pm = OpticalElement(
			...
			Name='pm')
		pm_p.ComputationSettings.UseFigureError = UseFigureError
		...
		d.Orientation = Optics.OPTICS_ORIENTATION.Any
